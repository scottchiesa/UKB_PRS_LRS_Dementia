...
***************************************************************************
***************PRS Analyses Stratified for ApoE4 Carriage******************
***************************************************************************
...
**PRS**	
	...
	forvalues i = 1/10	{
		...
		quietly {
			...
			log using "PRS_allcause_noe4.csv", replace text name(table)
...
import delimited "PRS_allcause_noe4.csv", delimiter(space) clear 
egen PRS_Results = rowmean(v2 v3 v4 v5 v6 v7 v8 v9 v10 v11) 
save PRS_allcause_noe4_results, replace
		restore
	}
...
**PRS Tertiles**
	...
	forvalues i = 1/10	{
		...
		quietly {
			capture log close table
			log using "PRS_allcause_tertiles_noe4.csv", replace text name(table)
...
import delimited "PRS_allcause_tertiles_noe4.csv", delimiter(space) clear 
egen PRS_tertiles_Results = rowmean(v2 v3 v4 v5 v6 v7 v8 v9 v10 v11) 
save PRS_allcause_tertiles_noe4_results, replace
		restore
				}
...
**PRS**	
	...
	forvalues i = 1/10	{
		...
		quietly {
			capture log close table
			log using "PRS_alzheimers_noe4.csv", replace text name(table)
...
import delimited "PRS_alzheimers_noe4.csv", delimiter(space) clear 
egen PRS_Results = rowmean(v2 v3 v4 v5 v6 v7 v8 v9 v10 v11) 
save PRS_alzheimers_noe4_results, replace
		restore
	}
...
**PRS Tertiles**
	...
	forvalues i = 1/10	{
		...
		quietly {
			capture log close table
			log using "PRS_alzheimers_tertiles_noe4.csv", replace text name(table)
...
import delimited "PRS_alzheimers_tertiles_noe4.csv", delimiter(space) clear 
egen PRS_tertiles_Results = rowmean(v2 v3 v4 v5 v6 v7 v8 v9 v10 v11) 
save PRS_alzheimers_tertiles_noe4_results, replace
		restore
				}
...
**PRS**	
	...
	forvalues i = 1/10	{
		...
		quietly {
			capture log close table
			log using "PRS_vascular_noe4.csv", replace text name(table)
...
import delimited "PRS_vascular_noe4.csv", delimiter(space) clear 
egen PRS_Results = rowmean(v2 v3 v4 v5 v6 v7 v8 v9 v10 v11) 
save PRS_vascular_noe4_results, replace
		restore
	}
...
**PRS Tertiles**
	...
	forvalues i = 1/10	{
		...
		quietly {
			capture log close table
			log using "PRS_vascular_tertiles_noe4.csv", replace text name(table)
...
import delimited "PRS_vascular_tertiles_noe4.csv", delimiter(space) clear 
egen PRS_tertiles_Results = rowmean(v2 v3 v4 v5 v6 v7 v8 v9 v10 v11) 
save PRS_vascular_tertiles_noe4_results, replace
		restore
		}
...
**PRS**	
	...
	forvalues i = 1/10	{
		...
		quietly {
			capture log close table
			log using "PRS_allcause_e4.csv", replace text name(table)
...
import delimited "PRS_allcause_e4.csv", delimiter(space) clear 
egen PRS_Results = rowmean(v2 v3 v4 v5 v6 v7 v8 v9 v10 v11) 
save PRS_allcause_e4_results, replace
		restore
	}
...
**PRS Tertiles**
	...
	forvalues i = 1/10	{
		...
		quietly {
			capture log close table
			log using "PRS_allcause_tertiles_e4.csv", replace text name(table)
...
import delimited "PRS_allcause_tertiles_e4.csv", delimiter(space) clear 
egen PRS_tertiles_Results = rowmean(v2 v3 v4 v5 v6 v7 v8 v9 v10 v11) 
save PRS_allcause_tertiles_e4_results, replace
		restore
				}
...
**PRS**	
	...
	forvalues i = 1/10	{
		...
		quietly {
			capture log close table
			log using "PRS_alzheimers_e4.csv", replace text name(table)
...
import delimited "PRS_alzheimers_e4.csv", delimiter(space) clear 
egen PRS_Results = rowmean(v2 v3 v4 v5 v6 v7 v8 v9 v10 v11) 
save PRS_alzheimers_noe4_results, replace
		restore
	}
...
**PRS Tertiles**
	...
	forvalues i = 1/10	{
		...
		quietly {
			capture log close table
			log using "PRS_alzheimers_tertiles_e4.csv", replace text name(table)
...
import delimited "PRS_alzheimers_tertiles_e4.csv", delimiter(space) clear 
egen PRS_tertiles_Results = rowmean(v2 v3 v4 v5 v6 v7 v8 v9 v10 v11) 
save PRS_alzheimers_tertiles_e4_results, replace
		restore
				}
...
**PRS**	
	...
	forvalues i = 1/10	{
		...
		quietly {
			capture log close table
			log using "PRS_vascular_e4.csv", replace text name(table)
...
import delimited "PRS_vascular_e4.csv", delimiter(space) clear 
egen PRS_Results = rowmean(v2 v3 v4 v5 v6 v7 v8 v9 v10 v11) 
save PRS_vascular_e4_results, replace
		restore
	}
...
**PRS Tertiles**
	...
	forvalues i = 1/10	{
		...
		quietly {
			capture log close table
			log using "PRS_vascular_tertiles_e4.csv", replace text name(table)
...
import delimited "PRS_vascular_tertiles_e4.csv", delimiter(space) clear 
egen PRS_tertiles_Results = rowmean(v2 v3 v4 v5 v6 v7 v8 v9 v10 v11) 
save PRS_vascular_tertiles_e4_results, replace
		restore
		}
