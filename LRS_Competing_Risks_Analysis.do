...
**LRS**	
	...
	forvalues i = 1/10	{
		...
		quietly {
			...
			log using "LRS_allcause.csv", replace text name(table)
...
import delimited "LRS_allcause.csv", delimiter(space) clear 
egen PRS_Results = rowmean(v2 v3 v4 v5 v6 v7 v8 v9 v10 v11) 
save LRS_allcause_results, replace
		restore
	}
...
**LRS Tertiles**
	...
	forvalues i = 1/10	{
		...
		quietly {
			capture log close table
			log using "LRS_allcause_tertiles.csv", replace text name(table)
...
import delimited "LRS_allcause_tertiles.csv", delimiter(space) clear 
egen LRS_tertiles_Results = rowmean(v2 v3 v4 v5 v6 v7 v8 v9 v10 v11) 
save LRS_allcause_tertiles_results, replace
		restore
				}
...
**LRS**	
	...
	forvalues i = 1/10	{
		...
		quietly {
			capture log close table
			log using "LRS_alzheimers.csv", replace text name(table)
...
import delimited "LRS_alzheimers.csv", delimiter(space) clear 
egen LRS_Results = rowmean(v2 v3 v4 v5 v6 v7 v8 v9 v10 v11) 
save LRS_alzheimers_results, replace
		restore
	}
...
**LRS Tertiles**
	...
	forvalues i = 1/10	{
		...
		quietly {
			capture log close table
			log using "LRS_alzheimers_tertiles.csv", replace text name(table)
...
import delimited "LRS_alzheimers_tertiles.csv", delimiter(space) clear 
egen LRS_tertiles_Results = rowmean(v2 v3 v4 v5 v6 v7 v8 v9 v10 v11) 
save LRS_alzheimers_tertiles_results, replace
		restore
				}
...
**LRS**	
	...
	forvalues i = 1/10	{
		...
		quietly {
			capture log close table
			log using "LRS_vascular.csv", replace text name(table)
...
import delimited "LRS_vascular.csv", delimiter(space) clear 
egen LRS_Results = rowmean(v2 v3 v4 v5 v6 v7 v8 v9 v10 v11) 
save LRS_vascular_results, replace
		restore
	}
...
**PRS Tertiles**
	...
	forvalues i = 1/10	{
		...
		quietly {
			capture log close table
			log using "LRS_vascular_tertiles.csv", replace text name(table)
...
import delimited "LRS_vascular_tertiles.csv", delimiter(space) clear 
egen LRS_tertiles_Results = rowmean(v2 v3 v4 v5 v6 v7 v8 v9 v10 v11) 
save LRS_vascular_tertiles_results, replace
		restore
		}
