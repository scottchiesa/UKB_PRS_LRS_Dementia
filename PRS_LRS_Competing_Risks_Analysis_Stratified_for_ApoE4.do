...
***************************************************************************
************PRS & LRS Analyses Stratified for ApoE4 Carriage***************
***************************************************************************
...
timer on 1
	...
	forvalues i = 1/10	{
		...
		quietly {
			...
			log using "PRS_LRS_allcause_tertiles_noe4.csv", replace text name(table)
...
import delimited "PRS_LRS_allcause_tertiles_noe4.csv", delimiter(space) clear 
egen PRS_LRS_tertiles_Results = rowmean(v2 v3 v4 v5 v6 v7 v8 v9 v10 v11) 
save PRS_LRS_allcause_tertiles_noe4_results, replace
		restore
				}
...
timer on 2
	...
	forvalues i = 1/10	{
		...
		quietly {
			capture log close table
			log using "PRS_LRS_alzheimer_tertiles_noe4.csv", replace text name(table)
...
import delimited "PRS_LRS_alzheimer_tertiles_noe4.csv", delimiter(space) clear 
egen PRS_LRS_tertiles_Results = rowmean(v2 v3 v4 v5 v6 v7 v8 v9 v10 v11) 
save PRS_LRS_alzheimer_tertiles_noe4_results, replace
		restore
				}
...
timer on 3
	...
	forvalues i = 1/10	{
		...
		quietly {
			capture log close table
			log using "PRS_LRS_vascular_tertiles_noe4.csv", replace text name(table)
...
import delimited "PRS_LRS_vascular_tertiles_noe4.csv", delimiter(space) clear 
egen PRS_LRS_tertiles_Results = rowmean(v2 v3 v4 v5 v6 v7 v8 v9 v10 v11) 
save PRS_LRS_vascular_tertiles_noe4_results, replace
		restore
				}
...
timer on 4
	...
	forvalues i = 1/10	{
		...
		quietly {
			capture log close table
			log using "PRS_LRS_allcause_tertiles_e4.csv", replace text name(table)
...
import delimited "PRS_LRS_allcause_tertiles_e4.csv", delimiter(space) clear 
egen PRS_LRS_tertiles_Results = rowmean(v2 v3 v4 v5 v6 v7 v8 v9 v10 v11) 
save PRS_LRS_allcause_tertiles_e4_results, replace
		restore
				}
...
timer on 5
	...
	forvalues i = 1/10	{
		...
		quietly {
			capture log close table
			log using "PRS_LRS_alzheimer_tertiles_e4.csv", replace text name(table)
...
import delimited "PRS_LRS_alzheimer_tertiles_e4.csv", delimiter(space) clear 
egen PRS_LRS_tertiles_Results = rowmean(v2 v3 v4 v5 v6 v7 v8 v9 v10 v11) 
save PRS_LRS_alzheimer_tertiles_e4_results, replace
		restore
				}
...
timer on 6
	...
	forvalues i = 1/10	{
		...
		quietly {
			capture log close table
			log using "PRS_LRS_vascular_tertiles_e4.csv", replace text name(table)
...
import delimited "PRS_LRS_vascular_tertiles_e4.csv", delimiter(space) clear 
egen PRS_LRS_tertiles_Results = rowmean(v2 v3 v4 v5 v6 v7 v8 v9 v10 v11) 
save PRS_LRS_vascular_tertiles_e4_results, replace
		restore
				}
